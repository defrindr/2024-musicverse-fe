...
export default function Option(props: OptionType) {
  return (
    ...
    >
      ...
      <span
        className={`block text-sm capitalize ${props.active ? "text-white" : "text-gray-700"}`}
      >
        {props.description}
      </span>
      <img
        src={props.icon}
        alt=""
        className="absolute hidden sm:block top-[18.17px] right-[18.17px] w-[86.29px] h-[72.67px]"
      />
    </div>
  );
}
