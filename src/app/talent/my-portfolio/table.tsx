      ...
      fields={[
        {
          ...
          width: 50,
          className:
            "bg-[#101010] first:rounded-tl-lg first:rounded-bl-lg  last:rounded-tr-lg last:rounded-br-lg min-w-[200px]",
        ...
        },
        {
          ...
          width: (100 - 50) / 5,
          className:
            "bg-[#101010] first:rounded-tl-lg first:rounded-bl-lg  last:rounded-tr-lg last:rounded-br-lg min-w-[150px] text-center",
          value: function (item: PortfolioType) {
            return (
        ...
        },
        {
          ...
          width: (100 - 50) / 5,
          className:
            "bg-[#101010] first:rounded-tl-lg first:rounded-bl-lg  last:rounded-tr-lg last:rounded-br-lg min-w-[70px] md:min-w-auto text-center",
          value: function (item: PortfolioType) {
            return (
              <span className="text-white">
